defmodule HedwigGiphy.Responders.GifMeTest do
  use Hedwig.RobotCase

  @moduletag start_robot: true, name: "elix", responders: [{HedwigGiphy.Responders.GifMe, []}]

  describe "HedwigGiphy.Responders.GifMe" do
